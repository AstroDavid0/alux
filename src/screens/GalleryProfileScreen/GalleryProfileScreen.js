...
const GalleryProfileScreen = ({navigation,imagelink,index,text,likes,name,profile_pic}) => {
...
<Pressable onPress={() => navigation.navigate('Details',{imagelink:imagelink,text:text,likes:likes,name:name,profile_pic:profile_pic,navigation:navigation})}>
...
export default GalleryProfileScreen